  ...
  return (
    <Nav>
      <NavContainer className={isScroll ? "scrolled" : ""}>
        ...
        <ButtonContainer>
          <Button href="https://github.com/gauravChaurasiya18" target="blank">
            Github
          </Button>
          <Button
            href="https://www.linkedin.com/in/gaurav-chaurasiya-822056266/"
            target="blank"
          >
            LinkedIn
          </Button>
        ...
        {isOpen && (
          <MobileMenu isOpen={isOpen}>
            ...
            <MobileButtonContainer isOpen={isOpen}>
              <MobileButton
                href="https://github.com/gauravChaurasiya18"
                target="blank"
              >
                Github
              </MobileButton>
